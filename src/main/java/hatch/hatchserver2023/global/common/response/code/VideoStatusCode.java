...
public enum VideoStatusCode implements StatusCode {
    ...
    GET_COMMENT_LIST_SUCCESS(HttpStatus.OK, "2021", "댓글 목록 조회 성공"), //200
...
//    ALREADY_LIKED_BUT_SUCCESS(HttpStatus.OK, "2031", "이미 좋아요를 눌러서 새로운 좋아요를 추가하지 않았습니다."),   //200
    ...
    GET_LIKE_VIDEO_LIST_SUCCESS(HttpStatus.OK, "2032", "좋아요 누른 영상 목록 조회 성공"),    //200


    //4xx
    VIDEO_NOT_FOUND(HttpStatus.NOT_FOUND, "4401", "해당 동영상을 찾을 수 없음"), //404
    LIKE_NOT_FOUND(HttpStatus.NOT_FOUND, "4402", "해당 좋아요를 찾을 수 없습니다"),     //404
    ALREADY_LIKED(HttpStatus.BAD_REQUEST, "4030", "이미 좋아요를 눌러서 새로운 좋아요를 추가할 수 없습니다"), //400
